...
def generate_launch_description():
    ...
    urdf_path = os.path.join(
        get_package_share_directory('krontonbot_description'),
        'urdf',
        'krontonbot.xacro'
    )
    ...
    robot_name = LaunchConfiguration('robot_name', default='krontonbot')
    ...
    declare_robot_name_cmd = DeclareLaunchArgument(
        'robot_name', default_value='krontonbot',
    ...
    bridge_params = os.path.join(
        get_package_share_directory('krontonbot_gazebo'),
        'config',
        'bridge.yaml'
    )
